...
import NIMAMAX
from NIMAMAX.lib.curve.ttypes import *
...
╚══════════════════
"""
NIMAMAXan="u136360f65010efb7f8dc362cb2c3cc"
	    ...
	    if mid in op.param3:	        
		    ...
		    G = ale.getGroup(op.param1)
                    if len(G.members) <= wait["memberscancel"]:
                        ...
                        c = Message(to=op.param1, from_=None, text=None, contentType=13)
                        c.contentMetadata={'mid':NIMAMAXan}
                        ale.sendMessage(c)                        
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 25:
			...
			ale.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': NIMAMAXan}
                ale.sendMessage(msg)
...
#              if msg.from_ in Admin:
		...
		if msg.from_ in admin:
		    ...
		    ale.sendText(msg.to, "Khusus NIMAMAXan")
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
		    for i in gid:
			ale.sendText(i,"=======[NUMPANG BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~nimabot00")
...
#--------------------------------------------------------
		...
		try:
		    ...
		    ale.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto like by:NIMAMAXAN lb ke #punyaNIMAMAXan\nhttp://line.me/ti/p/~nimabot00")
...
#-----------------------------------------------
                ...
                try:
                    ...
                    details = "\n========INSTAGRAM INFO ========"
                    ale.sendText(msg.to, detail + user + user1 + followers + following + post + link + details)
                    ale.sendImageWithURL(msg.to, nadya)
                except Exception as njer:
                	ale.sendText(msg.to, str(njer))
...
#              if msg.from_ in admin:
              ...
              if msg.from_ in owner:
            	...
            	gif = ("https://media.giphy.comedia/l2JHVsQiOZrNMGzYsgiphy.gif","https://dia.giphy.com/media/Oglt2hbilzJS/200w.gif")
